...
_FAMILYPROTO_APIDEFAULTOVERRIDESENTRY = _descriptor.Descriptor(
  name='ApiDefaultOverridesEntry',
  full_name='google.fonts.FamilyProto.ApiDefaultOverridesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.fonts.FamilyProto.ApiDefaultOverridesEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='google.fonts.FamilyProto.ApiDefaultOverridesEntry.value', index=1,
...
_FAMILYPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='api_default_overrides', full_name='google.fonts.FamilyProto.api_default_overrides', index=10,
  ...
  nested_types=[_FAMILYPROTO_APIDEFAULTOVERRIDESENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_FAMILYPROTO_APIDEFAULTOVERRIDESENTRY.containing_type = _FAMILYPROTO
_FAMILYPROTO.fields_by_name['fonts'].message_type = _FONTPROTO
_FAMILYPROTO.fields_by_name['axes'].message_type = _AXISPROTO
_FAMILYPROTO.fields_by_name['api_default_overrides'].message_type = _FAMILYPROTO_APIDEFAULTOVERRIDESENTRY
...
FamilyProto = _reflection.GeneratedProtocolMessageType('FamilyProto', (_message.Message,), dict(
  ...
  ApiDefaultOverridesEntry = _reflection.GeneratedProtocolMessageType('ApiDefaultOverridesEntry', (_message.Message,), dict(
    DESCRIPTOR = _FAMILYPROTO_APIDEFAULTOVERRIDESENTRY,
    __module__ = 'fonts_public_pb2'
    # @@protoc_insertion_point(class_scope:google.fonts.FamilyProto.ApiDefaultOverridesEntry)
    ))
  ,
...
_sym_db.RegisterMessage(FamilyProto.ApiDefaultOverridesEntry)
...
_FAMILYPROTO_APIDEFAULTOVERRIDESENTRY.has_options = True
_FAMILYPROTO_APIDEFAULTOVERRIDESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
